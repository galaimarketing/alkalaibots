...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-[20vh] w-16 z-30">
      <div className="flex flex-col bg-blue-950/20 backdrop-blur-md border border-white/10 rounded-tr-2xl rounded-br-2xl overflow-hidden py-4">
        {/* Navigation */}
